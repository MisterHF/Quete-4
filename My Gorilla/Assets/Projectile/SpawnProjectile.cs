    ...
    void Update()
    {
        switch (ModeShoot.state)                                     // Toute cette partie du code est effectué grace et avec Gabriel MIMOUNI
        {
            case MovePlayer.STATE.WALKING:                           // (MovePlayer = ModeShoot script)   Dans le cas où le joueur se déplace
                if (Input.GetKeyDown(KeyCode.E))                     // si il appuie sur E il rentre en mode Aim et ne peut plus se déplacer
                {
                ...
                if (Input.GetKeyDown(KeyCode.A))                     // si on appuie sur A 
                {
            ...
            case MovePlayer.STATE.MOD_SHOOT:
                ...
                if (Input.GetKeyDown(KeyCode.E))                    // Si la touche E est présée troisième fois.
                {
